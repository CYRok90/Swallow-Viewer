...
def display_board_tab(sh):
    ...
    selected_indices = st.multiselect('그래프에 표시할 지수를 선택하세요.', index_names, default=index_names)
    ...
    selected_etfs = st.multiselect('그래프에 표시할 종목을 선택하세요.', etf_names, default=etf_names)
